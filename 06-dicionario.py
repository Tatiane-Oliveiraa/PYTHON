...
dic_produtos["mac"] *= 1.1 # acrescenta 10% no valor do produto
print(dic_produtos)
...
#verificar se te um item no dicionario

if "mac" in dic_produtos:
    print("Produto encontrado")
else:
    print("Produto não encontrado")

# como tornar 2 listas e 1 dicionario

lista_produtos = ["iphone", "mac", "apple watch", "airpod"]
lista_precos = [10000, 15000, 5000, 2000]


zip() #junta os elementos das listas
